...
% fix_intensity_bands([ OutputDirectory, input_names{ 1 }])
input_names{ 1 } = 'Angio_4X_Mouse2_Compiled_820um_renormalized.tif' ; OutputDirectory = 'E:\David\martinos\round 2\' ;

% vertical_preference_fudge_factor = 2 ;
...
% microns_per_voxel = [6.8, 6.8, 2 / vertical_preference_fudge_factor]; % [ y, x, z ] == microns_per_voxel
    ...
    switch start_workflow
        ...
        case 'energy'
            ...
            name_value_pair_inputs = {  'OutputDirectory',                   OutputDirectory, ...
                              ...
                              ...         'radius_of_smallest_vessel_in_microns',      6.8,                         ...                                       
