...
[Here is a Demonstration](https://github.com/UTFOIL/Vectorization-Public/blob/master/SLAVV_tutorial_readme.md) of the graphical curator interface (built-into the SLAVV software) on three large (~1 mm<sup>3</sup>) images of living adult mouse brain vasculature. The three images are all from the same mouse, approximately the same field of view, and timed 2 weeks apart.
