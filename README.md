...
The resulting vectorization can be exported in the standard file format: ```*.vmv``` ([VessMorphoVis plugin](https://github.com/BlueBrain/VessMorphoVis) to [Blender](https://www.blender.org/) due to [BBP](https://www.epfl.ch/research/domains/bluebrain/), described in [publication](https://pubmed.ncbi.nlm.nih.gov/32657395/) <!--and [documentation](https://github.com/UTFOIL/Vectorization-Public/blob/master/references/btaa461_supplementary_data.pdf)) -->

<!---or ```*.casx``` (due to [LPPD](https://lppd.bioe.uic.edu/), [documentation](https://github.com/UTFOIL/Vectorization-Public/blob/master/references/casxFileDocumentation.pdf)).-->
