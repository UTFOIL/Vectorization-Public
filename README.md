...
The resulting vectorization can be exported in the standard file formats: ```*.vmv``` (due to [BBP](https://www.epfl.ch/research/domains/bluebrain/), [documentation](https://github.com/UTFOIL/Vectorization-Public/blob/master/references/btaa461_supplementary_data.pdf)) or ```*.casx``` (due to [LPPD](https://lppd.bioe.uic.edu/), [documentation](https://github.com/UTFOIL/Vectorization-Public/blob/master/references/casxFileDocumentation.pdf)).
