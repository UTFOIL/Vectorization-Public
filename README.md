...
The resulting vectorization can be exported in the standard file formats: ```*.vmv``` ([documentation](https://github.com/UTFOIL/Vectorization-Public/blob/master/references/btaa461_supplementary_data.pdf)) or ```*.casx``` ([reference](https://lppd.bioe.uic.edu/), [documentation](https://github.com/UTFOIL/Vectorization-Public/blob/master/references/casxFileDocumentation.pdf)).
